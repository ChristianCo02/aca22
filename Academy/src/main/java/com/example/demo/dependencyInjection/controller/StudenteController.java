...
public class StudenteController {
	...
	@PatchMapping("/inserisciImmagineProfilo")
	public void inserisciImmagineProfilo(@RequestParam("imgP") MultipartFile imgP,@RequestParam Long id) throws IOException {
		
		studenteService.inserisciImmagineProfilo(imgP,id);
	...
	@DeleteMapping("/eliminaStudente")
	public void eliminaStudente(@RequestParam Long id) {

...
import { DettagliDocumentoComponent } from './dettagli-documento/dettagli-documento.component';
...
const routes: Routes = [
  ...
  {path: "academy/documenti/dettagliDocumento/:documento.id",component:DettagliDocumentoComponent}
];
